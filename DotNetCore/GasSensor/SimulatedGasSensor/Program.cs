...
namespace ScaleOut.DigitalTwin.Samples.SimulatedGasSensor
{
    internal class Program
    {
        public static void Main(string[] args)
        {
            ...
            {
                DebugHelper.StartIG(igName: "__SimulatedGasSensor_IG",
                                    startupParam: null,
                                    startupSignalPort: 45845,
                                    devConnectionString: "bootstrapGateways=localhost:721;ignoreKeyAppId=true");
            }

            Startup.RunWithSimulationSupport(new SimulatedGasSensorMessageProcessor(), new SimulationGasSensorProcessor(), args);
        }
    }
}
