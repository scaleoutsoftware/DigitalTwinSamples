...
namespace GasSensorPackage
{
    internal class Startup : IInvocationGridStartup
    {
        ...
        {
            _modulePackage.AddDigitalTwinModule<RealTimeGasSensorModel, RealTimeGasSensorMessageProcessor>("RealTimeGasSensor");
            _modulePackage.AddSimulationModule<SimulatedGasSensorModel, SimulatedGasSensorSimulationProcessor, SimulatedGasSensorMessageProcessor>("SimulatedGasSensor");
        }
    }
}
