...
public class Constants {
    ...
    public static int CONTROLLER_NORMAL_ALERTLEVEL          = 1;
    public static int INFRASTRUCTURE_NORMAL_ALERTLEVEL      = 1;

    // controller and infrastructure minor alert levels
    public static int CONTROLLER_MINOR_ALERT_LEVEL          = 3;
    public static int INFRASTRUCTURE_MINOR_ALERTLEVEL       = 2;

    // controller and infrastructure moderate alert levels
    public static int CONTROLLER_MODERATE_ALERTLEVEL        = 4;
    public static int INFRASTRUCTURE_MODERATE_ALERTLEVEL    = 3;

    // controller and infrastructure severe alert levels
    public static int CONTROLLER_SEVERE_ALERTLEVEL          = 20;
    public static int INFRASTRUCTURE_SEVERE_ALERTLEVEL      = 20;
