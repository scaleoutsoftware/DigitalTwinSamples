...
import com.scaleoutsoftware.digitaltwin.abstractions.InitContext;
...
public class DataSource extends DigitalTwinBase<DataSource> {
    ...
    @Override
    public void init(InitContext<DataSource> context) {
        super.init(context);
