...
public class DataSourceSimulationProcessor extends SimulationProcessor<DataSource> {
    ...
    @Override
    public ProcessingResult onInitSimulation(InitSimulationContext context, DataSource instance, Date epoch) {
        startTimeMs = epoch.getTime();
